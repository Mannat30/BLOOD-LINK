...
public class BloodAllocationController {
    ...
    public BloodAllocationController(BloodAllocationService bloodAllocationService) {
    ...
    public BloodAllocationResponse allocateBlood(
            ...
            @RequestBody BloodAllocationRequest request) {

        return bloodAllocationService.allocateBlood(donationId, request);
    }
    ...
    @GetMapping("/{id}")
    public BloodAllocationResponse getOne(@PathVariable UUID id) {
